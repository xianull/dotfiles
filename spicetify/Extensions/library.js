...
var library = (() => {
  ...
  var ConfigModal = (props) => {
    ...
    const modalRows = structure.map((modalRow, index) => {
      ...
      return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, header && index !== 0 && /* @__PURE__ */ import_react.default.createElement("br", null), header && /* @__PURE__ */ import_react.default.createElement("h2", {
        ...
        name: modalRow.name,
        desc: modalRow.desc
      }, /* @__PURE__ */ import_react.default.createElement(Element, null)));
    });
    return /* @__PURE__ */ import_react.default.createElement("div", {
  ...
  var ToggleFiltersButton = () => {
    const [direction, setDirection] = import_react4.default.useState(
  ...
  var SearchBar = (props) => {
    ...
    const searchIcon = /* @__PURE__ */ import_react8.default.createElement(IconComponent, {
    ...
    }, searchIcon)), /* @__PURE__ */ import_react8.default.createElement("button", {
  ...
  var ArtistMenuItem = () => {
    const { MenuItem } = Spicetify.ReactComponent;
    const { SVGIcons } = Spicetify;
    const context = import_react10.default.useContext(Spicetify.ContextMenuV2._context);
    const uri = context?.props?.uri;
    return /* @__PURE__ */ import_react10.default.createElement(MenuItem, {
      divider: "after",
      leadingIcon: /* @__PURE__ */ import_react10.default.createElement(leading_icon_default, {
        path: SVGIcons.plus2px
      }),
  ...
  var _CollectionsWrapper = class extends EventTarget {
    ...
    async getCollectionContents(uri, props) {
    ...
    async getContents(props) {
      ...
      const collection = collectionUri ? this.getCollection(collectionUri) : void 0;
      ...
      if (textFilter) {
        ...
        items = items.filter((collection2) => regex.test(collection2.name));
      }
      if (sortOrder) {
        items.sort(collection_sort_default(sortOrder, sortDirection === "reverse"));
      }
  ...
  function main(LocalStorageAPI) {
    ...
    Spicetify.ContextMenuV2.registerItem(/* @__PURE__ */ import_react11.default.createElement(album_menu_item_default, null), isAlbum);
    Spicetify.ContextMenuV2.registerItem(/* @__PURE__ */ import_react11.default.createElement(artist_menu_item_default, null), isArtist);
      ...
      setTimeout(() => {
        for (const el of Array.from(rootlist.children)) {
          ...
          if (uri?.includes("folder")) {
            ...
            if (imageUrl)
              import_react_dom.default.render(/* @__PURE__ */ import_react11.default.createElement(FolderImage, {
                url: imageUrl
              }), imageBox);
          }
        }
    ...
    function injectFiltersButton(ylx_filter) {
      ...
      import_react_dom.default.render(/* @__PURE__ */ import_react11.default.createElement(toggle_filters_default, null), toggleFiltersButton);
    }
    function injectCollapseButton(ylx_filter) {
      const collapseButton = document.createElement("span");
      collapseButton.classList.add("collapse-button");
      ylx_filter.appendChild(collapseButton);
      import_react_dom.default.render(/* @__PURE__ */ import_react11.default.createElement(collapse_button_default, null), collapseButton);
    }
