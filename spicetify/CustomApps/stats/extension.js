...
var stats = (() => {
  ...
  var useQueryShitty = (callback) => {
    ...
    const [status, setStatus] = import_react13.default.useState("pending");
  ...
  var PlaylistPage = ({ uri }) => {
    const query = (0, import_react13.useCallback)(() => getPlaylist(uri), [uri]);
    ...
    const statCards = Object.entries(analysis.analysis).map(([key, value]) => {
      return /* @__PURE__ */ import_react13.default.createElement(stat_card_default, {
        label: key,
        value: parseStat(key)(value)
      });
    });
    const artistCards = analysis.artists.contents.slice(0, 10).map((artist) => {
      return /* @__PURE__ */ import_react13.default.createElement(spotify_card_default, {
        type: "artist",
    ...
    }, /* @__PURE__ */ import_react13.default.createElement(stat_card_default, {
      label: "Total Tracks",
    ...
    })), /* @__PURE__ */ import_react13.default.createElement(shelf_default, {
      title: "Most Frequent Genres"
    }, /* @__PURE__ */ import_react13.default.createElement(chart_card_default, {
      data: analysis.genres
    }), /* @__PURE__ */ import_react13.default.createElement("div", {
      className: "main-gridContainer-gridContainer grid"
    }, statCards)), /* @__PURE__ */ import_react13.default.createElement(shelf_default, {
      title: "Release Year Distribution"
    }, /* @__PURE__ */ import_react13.default.createElement(chart_card_default, {
      data: analysis.releaseYears
    })));
  };
  var playlist_default = import_react13.default.memo(PlaylistPage);
  ...
  var Dropdown = (props) => {
    ...
    }, props.options.map((option, index) => /* @__PURE__ */ import_react14.default.createElement("option", {
      key: index,
      value: option
    }, option))));
  };
  ...
  var SliderInput = (props) => {
    ...
    return /* @__PURE__ */ import_react14.default.createElement("div", {
      className: "playback-progressbar playback-progressbar-isInteractive"
      ...
      className: "x-progressBar-progressBarBg"
    }, /* @__PURE__ */ import_react14.default.createElement("div", {
      className: "x-progressBar-sliderArea"
    }, /* @__PURE__ */ import_react14.default.createElement("div", {
      className: "x-progressBar-fillColor"
    })), /* @__PURE__ */ import_react14.default.createElement("div", {
  ...
  var ConfigRow = (props) => {
    ...
    }, props.name, props.desc && /* @__PURE__ */ import_react14.default.createElement(Spicetify.ReactComponent.TooltipWrapper, {
    ...
    }, /* @__PURE__ */ import_react14.default.createElement(TooltipIcon, null)))), /* @__PURE__ */ import_react14.default.createElement("div", {
      className: "col action"
    }, props.children));
  };
  var ConfigModal = (props) => {
    const { config, structure, appKey, updateAppConfig } = props;
    const [modalConfig, setModalConfig] = import_react14.default.useState({ ...config });
    const modalRows = structure.map((modalRow, index) => {
      ...
      const Element = () => {
        switch (modalRow.type) {
          case "toggle":
            return /* @__PURE__ */ import_react14.default.createElement(ToggleInput, {
              storageKey: key,
              value: currentValue,
              callback: updateItem
            });
          case "text":
            return /* @__PURE__ */ import_react14.default.createElement(TextInput, {
              storageKey: key,
              value: currentValue,
              callback: updateItem
            });
          case "dropdown":
            return /* @__PURE__ */ import_react14.default.createElement(Dropdown, {
              storageKey: key,
              value: currentValue,
          ...
          case "slider":
            return /* @__PURE__ */ import_react14.default.createElement(SliderInput, {
              storageKey: key,
              value: currentValue,
              min: modalRow.min,
              max: modalRow.max,
      ...
      return /* @__PURE__ */ import_react14.default.createElement(import_react14.default.Fragment, null, header && index !== 0 && /* @__PURE__ */ import_react14.default.createElement("br", null), header && /* @__PURE__ */ import_react14.default.createElement("h2", {
        className: "section-header"
      }, modalRow.sectionHeader), /* @__PURE__ */ import_react14.default.createElement(ConfigRow, {
        name: modalRow.name,
        desc: modalRow.desc
      }, /* @__PURE__ */ import_react14.default.createElement(Element, null)));
    });
    return /* @__PURE__ */ import_react14.default.createElement("div", {
    ...
    constructor(modalStructure, key) {
      ...
      this.launchModal = (callback) => {
        ...
        Spicetify.PopupModal.display({
          ...
          content: /* @__PURE__ */ import_react15.default.createElement(config_modal_default, {
            config: this.Config,
  ...
  (function stats() {
    ...
    const playlistEdit = new Topbar.Button("playlist-stats", "visualizer", () => {
      ...
      PopupModal.display({ title: "Playlist Stats", content: /* @__PURE__ */ import_react16.default.createElement(playlist_default, {
        uri: playlistUri
      }), isLarge: true });
    }, false, true);
